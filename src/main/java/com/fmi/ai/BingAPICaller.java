...
public class BingAPICaller {
     ...
     */
    public static Double search(String word, String[] dictionaryWords) {
        ...
        sb.append(" & (").append(dictionaryWords[0]);
        for (int i = 1; i < dictionaryWords.length - 1; i++) {
            sb.append(" | ").append(dictionaryWords[i]);
        }
     ...
     */
    public static Double search(String[] words) {
